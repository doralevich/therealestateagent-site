...
export const metadata: Metadata = pageMeta({
  title: "Contact",
  description:
    "Talk to Apollo Claw about The Real Estate Agent. Book a 30-minute consultation, or reach us by email or phone from Roslyn Heights, New York.",
  path: "/contact",
  keywords: ["contact Apollo Claw", "real estate AI consultation", "book AI demo real estate"],
});
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-cream rounded p-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                  Thirty minutes. We will look at your pipeline and show you exactly how the
                  agent would be configured.
                </p>
                <a
                  href={DEMO_LINK}
                  target="_blank"
              ...
              <div className="bg-cream rounded p-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                  Questions about CRM compatibility, scope, or pricing. We answer these
                  ourselves.
                </p>
                <a
