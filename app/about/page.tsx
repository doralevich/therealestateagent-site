...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "The Real Estate Agent is built by Apollo Claw, in-house on Long Island. Who builds it, why it exists, and how engagements are handled.",
  path: "/about",
  keywords: [
    "Apollo Claw",
    "David Oralevich",
        ...
        <section className="grid-light-section py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-ink leading-relaxed space-y-4">
              ...
              <p>
                What he saw was a gap. Real estate professionals were leaving business on
                the table, not because of bad salesmanship, but because the follow-up
                process could not scale with one person.
              </p>
              <p>
                So he built it. Apollo Claw and a portfolio of industry-specific AI agents,
                each one purpose-built for a role. The Real Estate Agent is built on the
                same foundation.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                The Real Estate Agent is one of a family of role-specific agents from Apollo
