...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "A chatbot waits to be asked. An agent has a job, its own memory of your business, and permission to act. Here is the difference, in plain terms.",
  ...
  keywords: [
    ...
    "private AI agent",
    "AI agent real estate explained",
  ],
});
...
const COMPARISON = [
  ...
  },
  {
    ...
    agent: "It keeps a working memory of your listings, clients, and how you write.",
  },
  {
    chatbot: "It can only tell you what to do.",
    agent: "It connects to your CRM, calendar, and inbox and does the step itself.",
  },
  {
    chatbot: "It is the same product for everyone.",
    agent: "It is configured around your market, your pipeline, and your voice.",
  },
  {
      ...
      <main>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                Real estate runs on information other people have entrusted to you: what a
                seller will really take, why a buyer is moving, what a client can afford.
                That is not material to hand to a shared consumer product.
              </p>
              <p>
                Your agent runs on its own instance. It is configured for you, it remembers
                only your business, and it uses least-privilege access to your systems
